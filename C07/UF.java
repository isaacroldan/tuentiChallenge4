...
//#  https://contest.tuenti.net/Challenges?id=7
//#  Isaac Roldan (@saky)
//#  
//##########################################
...
//UNION FIND ALGORITHM (slightly modified) FROM http://algs4.cs.princeton.edu/15uf/ 
//This algorithm needs at least 8GB of RAM, execute the Java adding the -Xmx8000m parameter
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        while (!StdIn.isEmpty()) {
            ...
            if ((uf.connected(0,999999999))) {
                StdOut.println("Connected at "+i);
                break;
            }
